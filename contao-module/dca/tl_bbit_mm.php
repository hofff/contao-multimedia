...
//			'label_callback' => array('MultimediaDCA', 'renderLabel'),
		...
		'operations' => array(
			'captions' => array(
				...
				'icon'	=> 'system/modules/hofff_multimedia/html/images/captions.png',
	...
	'fields' => array(
		...
		'video_sourcesLocal' => array (
			...
			'eval'			=> array(
				...
				'files'				=> true,
				'filesOnly'			=> true,
				'extensions'		=> implode(',', MultimediaVideo::getFileExtensions()),
				'decodeEntities'	=> true,
				'tl_class'			=> 'clr'
			),
			'load_callback' => array(
		...
		'video_sourcesExternalStream' => array (
			...
			'load_callback' => array(
				array('MultimediaDCA', 'loadVideoSourcesExternalStream'),
			),
			'save_callback' => array(
		...
		'video_sourcesRTMP' => array (
			...
			'eval'			=> array(
				...
				'columnFields' => array(
					'streamer' => array(
						'label'		=> &$GLOBALS['TL_LANG']['tl_bbit_mm']['video_sourcesStreamer'],
						'inputType'	=> 'text',
						'eval'		=> array(
							'style'			=> 'width: 242px;',
							'decodeEntities'=> true
			...
			'load_callback' => array(
				array('MultimediaDCA', 'loadVideoSourcesRTMP'),
			),
			'save_callback' => array(
		...
		'video_sourcesSMIL' => array (
			...
			'load_callback' => array(
				array('MultimediaDCA', 'loadVideoSourcesSMIL'),
			),
			'save_callback' => array(
		...
		'audiodesc_source' => array (
			...
			'reference'		=> &$GLOBALS['TL_LANG']['tl_bbit_mm']['audiodesc_sourceOptions'],
			'eval'			=> array(
				'submitOnChange'	=> true,
				'includeBlankOption'=> true,
				'blankOptionLabel'	=> &$GLOBALS['TL_LANG']['MSC']['blankOption'],
