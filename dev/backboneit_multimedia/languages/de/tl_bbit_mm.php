...
$GLOBALS['TL_LANG']['tl_bbit_mm']['local']
	= array('Medien-Datei auswählen', 'Video\'s: .swf, .flv, .mp4, .m4v, .ogv (nicht von allen Browsern unterstützt) - Bilder: .jpg, .jpeg, .png, .gif - Audio: .mp3, .aac');
$GLOBALS['TL_LANG']['tl_bbit_mm']['url']
	= array('Medium', 'Eine URL (inkl. "http://") zum externen Medium.');


$GLOBALS['TL_LANG']['tl_bbit_mm']['expert_legend']
	= 'Experten-Einstellungen';
$GLOBALS['TL_LANG']['tl_bbit_mm']['startparam']
